...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = () => {
    // Redirects to /api/auth/google — the API handles the OAuth flow
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/auth/forgot-password" className="text-xs text-kunda-600 hover:text-kunda-700">Forgot password?</Link>
            </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            Don't have an account? <Link href="/auth/register" className="text-kunda-600 font-medium">Create one</Link>
          </p>
        </div>
      </div>
    </div>
