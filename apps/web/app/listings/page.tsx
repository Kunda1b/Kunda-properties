...
export const metadata: Metadata = { title: "Properties For Sale in The Gambia" };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-24">
        <div className="container mx-auto px-4 py-8">
          ...
          <Suspense fallback={<div className="grid md:grid-cols-3 gap-6">{[1,2,3,4,5,6].map((i)=><div key={i} className="h-80 bg-gray-100 animate-pulse rounded-2xl"/>)}</div>}>
